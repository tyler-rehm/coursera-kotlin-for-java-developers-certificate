...
// Cell data class representing a single cell in the board
data class Cell(val i: Int, val j: Int) {
    override fun toString() = "($i, $j)"
}

// Enum representing the direction for neighbors
...
// SquareBoard interface defining a square board and its operations
...
// GameBoard interface extending SquareBoard to store values in cells
